...
from shopify_bg.carts.models import CartItem
...
def search(request):
    if 'keyword' in request.GET:
        ...
        if keyword:
            products = Product.objects.filter(Q(description__icontains=keyword) | Q(product_name__icontains=keyword)).order_by('-date_created')
            product_count = products.count()
